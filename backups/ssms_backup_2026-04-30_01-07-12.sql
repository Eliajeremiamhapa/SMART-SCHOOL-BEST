...
CREATE TABLE `asset_maintenance` (
  ...
  KEY `idx_maintenance_asset_date` (`asset_id`,`maintenance_date`),
  KEY `idx_maintenance_cost` (`cost`),
...
CREATE TABLE `assets` (
  ...
  `category` enum('Samani','Elektroniki','Magari','Majengo') NOT NULL,
  `department` varchar(100) NOT NULL,
  `custodian_id` int(11) DEFAULT NULL,
  `purchase_price` decimal(15,2) NOT NULL,
  `useful_life` int(11) NOT NULL COMMENT 'Miaka inayokadiriwa kifaa kutumiwa',
  `asset_status` enum('Nzima','Inahitaji Service','Mbovu','Imeuzwa') DEFAULT 'Nzima',
  `asset_image` varchar(500) DEFAULT NULL,
...
INSERT INTO `assets` (`asset_id`, `asset_name`, `category`, `department`, `custodian_id`, `purchase_price`, `useful_life`, `asset_status`, `asset_image`, `purchase_date`, `current_value`, `notes`, `created_by`, `created_at`, `updated_at`) VALUES ('1', 'TOYOTA', 'Magari', 'Maintenance', '3', '300000.00', '3', 'Nzima', 'uploads/assets/1777480242_69f232321cd5c.png', '2026-04-29', '300000.00', '', '4', '2026-04-29 19:30:42', '2026-04-29 19:30:42');
INSERT INTO `assets` (`asset_id`, `asset_name`, `category`, `department`, `custodian_id`, `purchase_price`, `useful_life`, `asset_status`, `asset_image`, `purchase_date`, `current_value`, `notes`, `created_by`, `created_at`, `updated_at`) VALUES ('2', 'BUS', 'Magari', 'Maintenance', '3', '400000.00', '2', 'Nzima', 'uploads/assets/1777480791_69f234579c635.png', '2026-04-29', '400000.00', 'PPPP', '4', '2026-04-29 19:39:51', '2026-04-29 19:39:51');
INSERT INTO `assets` (`asset_id`, `asset_name`, `category`, `department`, `custodian_id`, `purchase_price`, `useful_life`, `asset_status`, `asset_image`, `purchase_date`, `current_value`, `notes`, `created_by`, `created_at`, `updated_at`) VALUES ('3', 'BUS', 'Magari', 'Maintenance', '9', '400000.00', '2', 'Nzima', 'uploads/assets/1777480806_69f2346626e71.png', '2026-04-29', '400000.00', 'PPPP', '4', '2026-04-29 19:40:06', '2026-04-29 19:49:40');
INSERT INTO `assets` (`asset_id`, `asset_name`, `category`, `department`, `custodian_id`, `purchase_price`, `useful_life`, `asset_status`, `asset_image`, `purchase_date`, `current_value`, `notes`, `created_by`, `created_at`, `updated_at`) VALUES ('5', 'TOYOTA2', 'Magari', 'Maintenance', '3', '40000000.00', '2', 'Nzima', 'uploads/assets/1777482158_69f239ae5d85b.png', '2026-04-29', '40000000.00', 'DDDD', '4', '2026-04-29 20:02:38', '2026-04-29 20:02:38');
INSERT INTO `assets` (`asset_id`, `asset_name`, `category`, `department`, `custodian_id`, `purchase_price`, `useful_life`, `asset_status`, `asset_image`, `purchase_date`, `current_value`, `notes`, `created_by`, `created_at`, `updated_at`) VALUES ('6', 'TOYOTA3', 'Magari', 'Maintenance', '3', '4000000.00', '2', 'Nzima', 'uploads/assets/1777483117_69f23d6dbc2f8.png', '2026-04-28', '4000000.00', '', '4', '2026-04-29 20:18:37', '2026-04-29 20:18:37');
INSERT INTO `assets` (`asset_id`, `asset_name`, `category`, `department`, `custodian_id`, `purchase_price`, `useful_life`, `asset_status`, `asset_image`, `purchase_date`, `current_value`, `notes`, `created_by`, `created_at`, `updated_at`) VALUES ('7', 'TOYOTA4', 'Magari', 'Maintenance', '3', '4000000.00', '2', 'Nzima', 'uploads/assets/1777483843_69f2404389a7e.png', '2026-04-29', '4000000.00', '', '4', '2026-04-29 20:30:43', '2026-04-29 20:30:43');
...
INSERT INTO `backup_records` (`id`, `filename`, `file_size`, `backup_type`, `status`, `created_by`, `created_at`) VALUES ('6', 'ssms_backup_2026-04-22_18-46-45.sql', '60.81 KB', 'manual', 'success', '4', '2026-04-22 19:46:46');
INSERT INTO `backup_records` (`id`, `filename`, `file_size`, `backup_type`, `status`, `created_by`, `created_at`) VALUES ('7', 'ssms_backup_2026-04-22_18-52-14.sql', '61.03 KB', 'manual', 'success', '4', '2026-04-22 19:52:14');
INSERT INTO `backup_records` (`id`, `filename`, `file_size`, `backup_type`, `status`, `created_by`, `created_at`) VALUES ('8', 'ssms_backup_2026-04-29_16-49-04.sql', '61.43 KB', 'manual', 'success', '4', '2026-04-29 17:49:04');
INSERT INTO `backup_records` (`id`, `filename`, `file_size`, `backup_type`, `status`, `created_by`, `created_at`) VALUES ('9', 'ssms_backup_2026-04-30_01-02-33.sql', '70.68 KB', 'manual', 'success', '4', '2026-04-30 02:02:34');
...
INSERT INTO `departments` (`dept_id`, `dept_name`, `dept_code`, `description`, `is_active`, `created_at`) VALUES ('1', 'Taaluma', 'TAA', 'Idara ya masomo na taaluma', '1', '2026-04-29 18:10:59');
INSERT INTO `departments` (`dept_id`, `dept_name`, `dept_code`, `description`, `is_active`, `created_at`) VALUES ('2', 'Uhasibu', 'UHA', 'Idara ya fedha na uhasibu', '1', '2026-04-29 18:10:59');
INSERT INTO `departments` (`dept_id`, `dept_name`, `dept_code`, `description`, `is_active`, `created_at`) VALUES ('3', 'Michezo', 'MIC', 'Idara ya michezo na burudani', '1', '2026-04-29 18:10:59');
INSERT INTO `departments` (`dept_id`, `dept_name`, `dept_code`, `description`, `is_active`, `created_at`) VALUES ('4', 'Usimamizi', 'USI', 'Idara ya usimamizi mkuu', '1', '2026-04-29 18:10:59');
INSERT INTO `departments` (`dept_id`, `dept_name`, `dept_code`, `description`, `is_active`, `created_at`) VALUES ('5', 'Library', 'LIB', 'Idara ya maktaba', '1', '2026-04-29 18:10:59');
INSERT INTO `departments` (`dept_id`, `dept_name`, `dept_code`, `description`, `is_active`, `created_at`) VALUES ('6', 'Transport', 'TRP', 'Idara ya usafiri', '1', '2026-04-29 18:10:59');
INSERT INTO `departments` (`dept_id`, `dept_name`, `dept_code`, `description`, `is_active`, `created_at`) VALUES ('7', 'Maintenance', 'MAI', 'Idara ya matengenezo na majengo', '1', '2026-04-29 18:10:59');
...
INSERT INTO `system_logs` (`id`, `user_id`, `action`, `description`, `ip_address`, `user_agent`, `created_at`) VALUES ('3', '4', 'Created User', 'Created new store_keeper account: york', '::1', NULL, '2026-04-30 01:01:35');
...
INSERT INTO `teacher_subjects` (`id`, `teacher_id`, `subject`, `class`, `academic_year`, `created_at`) VALUES ('3', '9', 'Kiingereza', 'Standard 5', '2025', '2026-04-22 19:53:14');
...
INSERT INTO `users` (`id`, `username`, `password`, `full_name`, `email`, `phone`, `nin_number`, `employment_id`, `role`, `is_active`, `created_at`, `last_login`, `last_ip`, `profile_pic`, `login_attempts`, `locked_until`) VALUES ('19', 'york', '$2y$10$og.562ixipjwGLXMhDorPON1kv.blPeM/SN7yNn9giAWiHYUeSa2e', 'york', 'eliamhapa34@gmail.com', '0692416596', NULL, NULL, 'store_keeper', '1', '2026-04-30 01:01:34', NULL, NULL, NULL, '0', NULL);

DROP TABLE IF EXISTS `v_asset_summary`;
v_asset_summary;

INSERT INTO `v_asset_summary` (`asset_status`, `total_count`, `total_purchase_value`, `total_current_value`, `avg_value`) VALUES ('Nzima', '6', '49100000.00', '49100000.00', '8183333.333333');

DROP TABLE IF EXISTS `v_assets_by_department`;
v_assets_by_department;

INSERT INTO `v_assets_by_department` (`department`, `total_assets`, `total_value`, `total_current_value`) VALUES ('Maintenance', '6', '49100000.00', '49100000.00');

DROP TABLE IF EXISTS `v_maintenance_costs`;
v_maintenance_costs;

INSERT INTO `v_maintenance_costs` (`asset_id`, `asset_name`, `maintenance_count`, `total_maintenance_cost`, `avg_maintenance_cost`) VALUES ('1', 'TOYOTA', '0', NULL, NULL);
INSERT INTO `v_maintenance_costs` (`asset_id`, `asset_name`, `maintenance_count`, `total_maintenance_cost`, `avg_maintenance_cost`) VALUES ('2', 'BUS', '0', NULL, NULL);
INSERT INTO `v_maintenance_costs` (`asset_id`, `asset_name`, `maintenance_count`, `total_maintenance_cost`, `avg_maintenance_cost`) VALUES ('3', 'BUS', '0', NULL, NULL);
INSERT INTO `v_maintenance_costs` (`asset_id`, `asset_name`, `maintenance_count`, `total_maintenance_cost`, `avg_maintenance_cost`) VALUES ('5', 'TOYOTA2', '0', NULL, NULL);
INSERT INTO `v_maintenance_costs` (`asset_id`, `asset_name`, `maintenance_count`, `total_maintenance_cost`, `avg_maintenance_cost`) VALUES ('6', 'TOYOTA3', '0', NULL, NULL);
INSERT INTO `v_maintenance_costs` (`asset_id`, `asset_name`, `maintenance_count`, `total_maintenance_cost`, `avg_maintenance_cost`) VALUES ('7', 'TOYOTA4', '0', NULL, NULL);
